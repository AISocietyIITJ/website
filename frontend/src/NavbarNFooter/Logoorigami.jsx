...
import {  SiGithub, SiInstagram, SiLinkedin, SiMeta,  } from "react-icons/si";
import { twMerge } from "tailwind-merge";

export const DivOrigami = () => {
  return (
    <section className="flex h-12 flex-col items-center justify-center gap-12 bg-white px-4 py-24 md:flex-row">
      <LogoRolodex
        items={[
